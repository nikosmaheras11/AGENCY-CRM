        ...
        <div class="flex gap-4 h-full pb-4">
          ...
          >
            ...
            <div class="flex-1 overflow-y-auto space-y-3 pr-1">
              ...
              >
                <!-- Thumbnail -->
                <div class="relative aspect-video rounded-t-lg overflow-hidden bg-gradient-to-br from-gray-100 to-gray-200">
                  <!-- Video placeholder or actual thumbnail -->
                  <div class="absolute inset-0 flex items-center justify-center">
                    <span class="material-icons text-gray-400 text-5xl">play_circle</span>
                  </div>
