...
-- This is for task/request discussions, NOT spatial asset comments
...
-- Users can create comments on requests they can access
...
-- Comment: This table is SEPARATE from asset_comments
-- asset_comments = spatial/positioned comments on creative assets (x,y coordinates)
-- request_comments = task-level discussion comments about the request itself
